...
--
-- Servidor: localhost
-- Tiempo de generación: 09-02-2023 a las 17:35:16
...
CREATE TABLE `BOT_001_Chat` (
  ...
  `idio` varchar(8) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `tipo` varchar(1) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `clas` varchar(32) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `preg` text CHARACTER SET utf32 COLLATE utf32_spanish_ci,
  `resp` text CHARACTER SET utf32 COLLATE utf32_spanish_ci,
  `obse` text CHARACTER SET utf32 COLLATE utf32_spanish_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `DIC_Rutas`
--

CREATE TABLE `DIC_Rutas` (
  `id` int UNSIGNED NOT NULL,
  `skey` varchar(64) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `titu` varchar(512) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  ...
  `cont` text CHARACTER SET utf32 COLLATE utf32_spanish_ci,
  `meta` text CHARACTER SET utf32 COLLATE utf32_spanish_ci,
...
CREATE TABLE `GEO_001_Paises` (
  ...
  `iso3166a1` char(2) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
  `iso3166a2` char(3) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
  `nombre` varchar(128) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
CREATE TABLE `GEO_002_Ciudades` (
  ...
  `ciudad` varchar(200) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
...
CREATE TABLE `GEO_003_Estados` (
  `id_estado` int NOT NULL,
  `estado` varchar(250) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `iso_3166-2` varchar(4) CHARACTER SET utf32 COLLATE utf32_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
CREATE TABLE `GEO_004_Municipios` (
  ...
  `id_estado` int NOT NULL,
  `municipio` varchar(100) CHARACTER SET utf32 COLLATE utf32_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
CREATE TABLE `GEO_005_Parroquias` (
  ...
  `id_municipio` int NOT NULL,
  `parroquia` varchar(250) CHARACTER SET utf32 COLLATE utf32_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
CREATE TABLE `SEC_001_Aplicacion` (
  `id` int UNSIGNED NOT NULL,
  `type` int NOT NULL COMMENT 'Tipo de aplicacion',
  `serv` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Servidor de destino',
  `nomb` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Nombre de Aplicacion',
  `vers` varchar(16) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Version',
  `sope` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Sistema Operativo',
  `db` varchar(64) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Inclusion de Base de datos',
  `idio` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Idioma del sistema',
  `obse` text CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Observaciones del sistema',
  `repo` text CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Repositorio de datos',
  `usua` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Usuario de la cuenta',
  `pass` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Clave de acceso a repositorio',
  `pmon` varchar(256) COLLATE utf32_spanish_ci NOT NULL COMMENT 'Punto de montaje',
  `user` varchar(30) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Usuario creador',
  `fech` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Fecha de creacion',
  `esta` int NOT NULL COMMENT '0 Clonar 1 Actualizar 2 Publicado'
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci COMMENT='Aplicaciones del sistema';

--
-- Volcado de datos para la tabla `SEC_001_Aplicacion`
--

INSERT INTO `SEC_001_Aplicacion` (`id`, `type`, `serv`, `nomb`, `vers`, `sope`, `db`, `idio`, `obse`, `repo`, `usua`, `pass`, `pmon`, `user`, `fech`, `esta`) VALUES
(1, 3, 'github', 'Panel', '0.0.1', 'LINUX', 'MONGODB', 'TSC', 'Panel de Control', 'code-epic/consola', 'gesaodin', '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', '/dist', '', '2023-02-07 14:12:58', 0);
...
CREATE TABLE `SEC_002_Api` (
  ...
  `nomb` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `idfunc` varchar(128) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL COMMENT 'Id de la Funcion HEX',
  `func` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `descr` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `param` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `esta` int NOT NULL,
  `idapp` int UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci COMMENT='Relacion de confianza entre app y api';
...
(1, 'seguridad', '60e4bf949727d7cd4fec89e1', 'LstModulos', 'Permite listar los modulos de un sistema en especifico', '', 1, 1);
...
CREATE TABLE `SEC_003_Conexion` (
  `id` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `nomb` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `func` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `descr` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `param` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
...
CREATE TABLE `SEC_004_Modulo` (
  `id` int UNSIGNED NOT NULL,
  `nomb` varchar(64) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `descr` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `idapp` int UNSIGNED DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
CREATE TABLE `SEC_005_Menu` (
  `id` int UNSIGNED NOT NULL,
  `nomb` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `url` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `js` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `icon` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `clase` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `color` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `type` int NOT NULL,
...
(1, 'Comunicaciones', '/v1/api/crud:61afe403149ead557e7d0c82', 'cargarstyle()', 'icon-test', 'new-top', 'gb-waring', 1, 1);
...
CREATE TABLE `SEC_007_Accion` (
  `id` int UNSIGNED NOT NULL,
  `endpoint` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `nomb` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `func` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `direc` varchar(256) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
(1, 'v1/api/crud:{id}', 'Fnx_Clonar', 'ListarPaises', 'sdfg');
...
--
-- Estructura de tabla para la tabla `SEC_999_Usuario`
--

CREATE TABLE `SEC_999_Usuario` (
  `id` int NOT NULL COMMENT 'serial',
  `key` varchar(24) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `carg` varchar(25) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `cedu` varchar(8) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `usua` varchar(11) CHARACTER SET utf32 COLLATE utf32_general_ci DEFAULT NULL,
  `nomb` varchar(37) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL,
  `sist` varchar(21) CHARACTER SET utf32 COLLATE utf32_spanish_ci DEFAULT NULL
...
CREATE TABLE `tech` (
  `oid` int NOT NULL,
  `nombre` varchar(64) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
  `version` varchar(16) CHARACTER SET utf32 COLLATE utf32_spanish_ci NOT NULL,
...
(1, 'cbhulito', 'control', '2022-10-13 23:01:27');
...
--
-- Indices de la tabla `DIC_Rutas`
--
ALTER TABLE `DIC_Rutas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `view` (`view`,`fech`);
...
--
-- Indices de la tabla `SEC_999_Usuario`
--
ALTER TABLE `SEC_999_Usuario`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `DIC_Rutas`
--
ALTER TABLE `DIC_Rutas`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `SEC_999_Usuario`
--
ALTER TABLE `SEC_999_Usuario`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'serial';

--
-- AUTO_INCREMENT de la tabla `tech`
--
ALTER TABLE `tech`
